...
public class Application01 {
    public static void main(String[] args) {
         ...
         * 하나의 메소드 홏ㄹ로 객체별로 각기 다른 방법으로 동작하게 될 수도 있다
         *
         ...
         * (다양한 기능을 사용하는데 있어서 관리해야할 메세지 종류가 줄어든게 된다)
         * 하나의 ㅎ출로 여러가지 동작을 수행할 수 있다는 측면에서 오버로딩을 다형성으로 보기도 한다
         * 다형성을 이해하기 쉬운 가장 좋은 예 이기도 하ㅈ다
