...
public class Application03 {
    public static void main(String[] args) {
        ...
        *   2-2. 변수명의 합성어로 이루어진 경우 첫 단어는 소문자, 두 번째 단어의 시작은 대문자로 한다(camel-case)
        ...
        */
        ...
        int helloworldmynameisleenarae; 
        ...
        // 2-3 단어와 단어 사이의 연결은 언도스코어(_)를 사용하지 않는다
        ...
        boolean isDead = false; // 부정적 의미는 잘 사용하지 않는다
