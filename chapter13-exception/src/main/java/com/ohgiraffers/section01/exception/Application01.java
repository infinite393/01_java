...
public class Application01 {
    public static void main(String[] args) throws Exception {
         ...
         *  엄밀히 말하면 문법상의 오륲 (Syntax Error) 이다
        ...
        /*
         * 오류(Error)
         *  시스템 상에서 프로그램에 심각한 문제를 발생하여 실행중인 프로그램이 종료 되는 것을 말한다
        ...
        exceptionTest.checkEnoughMoney(5000,10000);
        exceptionTest.checkEnoughMoney(5000,1000);
