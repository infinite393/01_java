package main.java.com.ohgiraffers.section03.stingbuilder;
...
public class Application02 {
    public static void main(String[] args) {
        ...
        // capacity() : 용량(현재 버퍼의 크기)를 정수형으로 반환하는 메소드 (문자열 길이 + 16이 기본 용량)
        ...
        */
        ...
        System.out.println("deleteCahrAt() : " + sb2.deleteCharAt(0));
        ...
        * charAt() , indexOf() / lastIndexOf(), length(), replace(), toString()
        */
