...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
         * Data 클래스
         * jdk 1.0 부터 날짜를 취급하기 위해 사용되던 data 클래스는
         * 생성자를 비롯하여 대부분의 메소드가 deprecated 되어 있다
         *
         * Deprecated?
         * 향후 버전이 업데이트 되면서 사라지게 될 기능이니 가급적이면 사용을 권장하지 않는다는 의미
         * 하지만 하위 버전의 호환성 때문에 한 번에 제거되는 것은 아니고 남겨두었기 때문에 사용하는 것이 가능하다
         *
         * jdk 1.1 부터는 새롭게 제공되는 calender 클래스를 이용하여 날짜와 시간에 관한 처리를 하게 된다
        ...
        Date time = new Date(1716270910380L);
