...
public class Application02 {
    public static void main(String[] args) {
        ...
        */
        ...
        Calendar choiceDay = new GregorianCalendar(year, month, dayOfMonth, hour, min, sec);
        System.out.println(choiceDay);

        /*
        * 상황에 따라 특정 일자를 기준으로 한 Date 타입의 인스턴스가 필요한 경우도 있따
        * 먼저 GregorianCalendar 를 이용해서 특정 날짜/시간 정보로 인스턴스를 생성한 후
        * 1970년 1춸 1일 0시 0분 0초 를 기준으로 지난 시간을 millisecond 로 계산해서 long 형으로 변환하는 메소드가 있다
        */
        ...
        */
        ...
        // 각 필드에 매칭되는 매개변수의 위치 정수를 다 외워야 사용이 가능해지기 떄문에
        // 상수 필드 형태로 제공 하고 있다
        ...
        System.out.println(choiceDay.get(Calendar.HOUR_OF_DAY));
        System.out.println(choiceDay.get(Calendar.HOUR));
