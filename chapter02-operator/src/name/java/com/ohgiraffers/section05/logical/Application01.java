package name.java.com.ohgiraffers.section05.logical;
...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 연산자의 결합 방식은 왼쪽에서 오른쪽이다
        * 두 개의 논리식을 판단하여 참과 거짓을 판단한다
        * 1-1. && (And 논리) : 두 개의 논리식 모두 참일 경우 참을 반환, 둘 중 하나라도 거짓인 경우 거짓을 반환
        * 1-2. || (or 논리) : 두 개의 논리식 중 하나라도 참일 경우 참을 반환, 두 개 모두 거짓인 경우 거짓을 반환
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단항 연산자
        * 2-1. ! (not 논리) : 논리식의 결과가 참이면 거짓, 거짓이면 참을 반환
        */
